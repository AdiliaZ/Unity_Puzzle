...
using UnityEngine;
using UnityEngine.SceneManagement; //для триггера
...
public class Player : MonoBehaviour
{
    ...
    private void FixedUpdate() //изменение положения куба при нажатии клавиш
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (this.CompareTag("Cube") && other.CompareTag("Cube")) //чтобы объекты не застрявали 
        {
